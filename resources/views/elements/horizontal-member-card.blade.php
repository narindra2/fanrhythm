                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <ul class="list-unstyled">
                                <div class="d-flex align-items-center" >@include('elements.icon',['icon'=>'checkmark-sharp','centered'=>false, 'classes' => 'mr-2 text-muted', 'variant'=>'medium'])  {{__("Accès complet à ce contenu de créateur gratuit")}}</div>
                                <li class="d-flex align-items-center" >@include('elements.icon',['icon'=>'checkmark-sharp','centered'=>false, 'classes' => 'mr-2 text-muted', 'variant'=>'medium']) {{__('Annulez votre abonnement gratuit à tout moment')}}</li>
                                <li class="d-flex align-items-center" >@include('elements.icon',['icon'=>'checkmark-sharp','centered'=>false, 'classes' => 'mr-2 text-muted', 'variant'=>'medium'])  {{__('Direct messages and access comments on public posts')}}</li>
                            </ul>
                        </p>
                        <style>
                            .btn-follow{
