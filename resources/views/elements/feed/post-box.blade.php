            ...
            <div>
                ...
                @if (Auth::id() !=  $post->user_id)
                    ...
                    <div class="bookmark-button {{ $isPostBookmarked  ? 'active' : ''}}"
                        id="bookmark-button-{{ $post->id }}"  data-toggle="tooltip" data-placement="top" data-original-title="{{  $isPostBookmarked ? __("Remove in my bookmarks") : __('Add to my bookmarks')}}"
