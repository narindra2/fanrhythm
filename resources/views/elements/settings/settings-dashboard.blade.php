<div class="aff_edit_info_form">
    ...
    <div class="aff_ref_link" style="padding: 0px 0px 0px 0px;">
        <div style= "cursor: pointer;border: 0px solid var(--text-dark) ;height: 39px ; background: var(--bg-card); border-radius: 8px; height: 55px; display: flex; align-items: center; padding: 0px 42% 0px 34%">
