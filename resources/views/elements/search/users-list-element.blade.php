@if($user->verification && $user->verification->status == 'verified') <div class="aff_search_user_list user-search-box-item user-search-box-item_change_color"  style="background: url('{{$user->cover}}');background-size:cover;background-repeat:no-repeat;background-position:center">
