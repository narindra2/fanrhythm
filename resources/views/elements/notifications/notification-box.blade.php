<div class="notification-box aff_user_notif {{!$notification->read?'unread':''}}">
    ...
    ">
        ...
        <a href="{{route('profile',['username'=>$notification->fromUser->username])}}"> <img
                src="{{\App\Providers\GenericHelperServiceProvider::getStorageAvatarPath(null)}}" alt="Avatar"> </a>
        ...
        <div>
            ...
            <div class="aff_info_name">
                <div>
                    <span>
                        <a
                            href="{{route('profile',['username'=>$notification->fromUser->username])}}">{{$notification->fromUser->name}}</a>
                        <span>
                            ...
                            {{__("aime votre ",['name'=>$notification->fromUser->name])}} <a
                            ...
                            {{__('a ajouté un commentaire sur votre',['name'=>$notification->fromUser->name])}} <a
