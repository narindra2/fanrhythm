                ...
                <div>
                    ...
                    <form role="form"
                        ...
                        @if($dataType->slug == 'user-verifies')
                            <div class="identity-files-preview xxx">
                        ...
                        @if (count($errors) > 0)
                            ...
                            @foreach($dataTypeRows as $row)
                                ...
                                <div class="{{ $row->getTranslatedAttribute('id') }} @if($row->type == 'hidden') hidden @endif {{ $errors->has($row->field) ? 'has-error' : '' }}" @if(isset($display_options->id)){{ "id=$display_options->id" }}@endif>
                                    {{ $row->slugify }}
                                    <label class="afrifan_setting_label"  for="name">{{ $row->getTranslatedAttribute('display_name') }}</label>
                        ...
                        <div class="afrifan_footer_button">
                            @section('submit-buttons')
                                <button type="submit" class="btn-primary afri_btn_2">{{ __('voyager::generic.save') }}</button>
                            @stop
