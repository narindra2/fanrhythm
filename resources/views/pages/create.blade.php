                        ...
                        <div class="aff_not">
                            <span data-toggle="tooltip" data-placement="bottom"
                                ...
                                <div class="post-notification-icon">
                                    @include('elements.icon',['icon'=>'notifications-off-outline','variant'=>'medium','centered'=>true,
                                    'classes' => 'mr-1'])
                                </div>
                            </span>
                        </div>
    ...
    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" opacity="0.352515811" stroke-linecap="round" stroke-linejoin="round">
        <g id="8---Fil-d'actualité---Pourboire" transform="translate(-1101.000000, -248.000000)" stroke="#000000">
            ...
            <div>
                ...
                <div id="aff_create_adds">
                    ...
                    <div>
                        ...
                        <span class=" file-upload-button {{ (isset($post) && $post->is_public ) ? "d-none" : ""  }} {{!GenericHelper::isUserVerified() && getSetting('site.enforce_user_identity_checks') ? 'disabled' : ''}}">
                                ...
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
                                    ...
                                    <g id="Message---Discussion" transform="translate(-1293.000000, -884.000000)"
                                        ...
                                        <g id="image" transform="translate(1294.000000, 885.000000)">
                                            <rect id="Rectangle" x="0" y="0" width="15.8333333" height="15" rx="2">
                                            </rect>
                            ...
                            <span class="">{{__("Photos et vidéos")}}</span>
                        </span>
                        ...
                        <span 
                            ...
                            <span class="d-none d-md-block">{{__("Prix")}}</span>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <span
                        class=" file-upload-button-public-post  {{!GenericHelper::isUserVerified() && getSetting('site.enforce_user_identity_checks') ? 'disabled' : ''}}">


                        <svg style="margin-right: 10px; margin-left: 10px;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe-americas" viewBox="0 0 16 16">
                            <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0M2.04 4.326c.325 1.329 2.532 2.54 3.717 3.19.48.263.793.434.743.484q-.121.12-.242.234c-.416.396-.787.749-.758 1.266.035.634.618.824 1.214 1.017.577.188 1.168.38 1.286.983.082.417-.075.988-.22 1.52-.215.782-.406 1.48.22 1.48 1.5-.5 3.798-3.186 4-5 .138-1.243-2-2-3.5-2.5-.478-.16-.755.081-.99.284-.172.15-.322.279-.51.216-.445-.148-2.5-2-1.5-2.5.78-.39.952-.171 1.227.182.078.099.163.208.273.318.609.304.662-.132.723-.633.039-.322.081-.671.277-.867.434-.434 1.265-.791 2.028-1.12.712-.306 1.365-.587 1.579-.88A7 7 0 1 1 2.04 4.327Z"/>
                          </svg>
                        <span class="">{{__("Public")}}</span>
                    </span>
                ...
                @if(!GenericHelper::isUserVerified() && getSetting('site.enforce_user_identity_checks'))
                <button class="btn btn-primary disabled mb-0" id="addPostbtn">{{__('Publier maintenant')}}</button>
                @else
                <button class="btn  btn-primary post-create-button" id="addPostbtn">{{__('Publier maintenant')}}</button>
                @endif
