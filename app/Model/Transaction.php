...
class Transaction extends Model
{
    ...
    const DIGITAL_VIRGO = 'digital-virgo';
    ...
    protected $fillable = [
        ...
        'nowpayments_order_id', 'stream_id', 'ccbill_subscription_id', 'user_message_id', 'paystack_transaction_token', 'transaction_id' ,"transaction_fees"
    ];
