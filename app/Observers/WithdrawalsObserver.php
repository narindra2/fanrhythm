        ...
        EmailsServiceProvider::sendGenericEmail(
            [
                ...
                'content' => __('Email withdrawal processed', [
                    ...
                    ]).($withdrawal->status == 'approved' ? ' '.SettingsServiceProvider::getWebsiteCurrencySymbol().$withdrawal->amount . (getSetting('payments.withdrawal_allow_fees')? '(-'.SettingsServiceProvider::getWebsiteCurrencySymbol().$withdrawal->amount / getSetting('payments.withdrawal_default_fee_percentage').' taxes)' :2) .' '.__('has been sent to your account.') : ''),
                'button' => $button,
            ]
        );
