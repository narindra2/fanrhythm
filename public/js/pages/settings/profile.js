...
$(function () {
    ...
    if(bioConfig.allow_profile_bio_markdown){
        ...
        ProfileSettings.mdeEditor = new SimpleMDE({
    ...
    initUploader:function (type) {
        ...
        ProfileSettings.dropzones[type] = new window.Dropzone(selector, {
            ...
            sending: function(file) {
                ...
                $("#attachementBreackModerationRulesMessage").addClass("d-none");
            },
            success: function(file, response) {
                if (!response.success && !response.isInModeration) {
                  return  $("#attachementBreackModerationRulesMessage").removeClass("d-none");
                }
