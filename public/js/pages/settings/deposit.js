        ...
        if (val) {
            switch (val) {
                ...
                case "payment-oxxo":
                    ...
                    break;
                case "payment-digital-virgo":
                    DepositSettings.provider = "digital-virgo";
                    break;
    ...
    initUploader: function () {
        try {
            ...
            DepositSettings.myDropzone.on("removedfile", function (file) {
                ...
                DepositSettings.uploadedFiles =
                    DepositSettings.uploadedFiles.filter(
                        (uploadedFile) =>
                            uploadedFile !== file.upload.attachmentId
                    );
            });
